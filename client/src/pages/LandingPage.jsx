  ...
  return (
    <div className='min-h-screen min-w-full bg-gradient-to-r from-slate-900 to-emerald-400 flex flex-col justify-center p-10'>
      <div className='relative w-full max-w-full lg:max-w-6xl xl:max-w-screen-2xl mx-auto'>
        <div className='absolute inset-0 -mr-3.5 bg-gradient-to-r from-emerald-300 to-slate-900 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:rotate-3 sm:rounded-3xl'></div>
        <div className='relative bg-gradient-to-r from-emerald-700 to-slate-900 shadow-lg sm:rounded-3xl'>
          ...
          <div className='px-12 py-8'>
            <div className='flex items-center justify-between'>
              <div className='flex items-center justify-center'>
                ...
                <div className='hidden lg:flex items-center justify-center antialiased lg:ml-20 pt-1'>
                  <a
                    href='#'
                    className='flex items-center justify-center mr-10 text-base text-white text-opacity-90 font-medium tracking-tight hover:text-cool-gray-600 transition duration-150 ease-in-out'>
                    Product
                    <svg
              ...
              <div className='hidden md:flex items-center justify-center'>
                <a
                  href='#'
                  className='mr-5 text-lg font-medium text-white hover:text-cool-gray-700 transition duration-150 ease-in-out'>
                  Login
                </a>
            ...
            <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between mt-20 lg:mt-10 lg:ml-16'>
              <div className='text-left lg:w-1/2'>
                <div className='text-6xl font-semibold text-green-100 leading-none'>
                  Effortless Text Summarization
                </div>
                <div className='mt-6 text-xl font-light text-green-200 antialiased'>
                  Instantly condense lengthy documents into concise summaries.
                </div>
                <button className='mt-6 px-8 py-4 rounded-full font-normal tracking-wide bg-gradient-to-b from-green-200 to-green-500 text-white outline-none focus:outline-none hover:shadow-lg hover:from-green-700 transition duration-200 ease-in-out'>
                  Get Started
                </button>
              </div>
